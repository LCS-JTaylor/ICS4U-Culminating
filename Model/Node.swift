...
let nodes = [
    ...
    9 : Node (id: 9, paragraphs: [], image: nil, edges: [], ending: false)
    ...
    19 : Node (id: 19, paragraphs: ["You decide to ignore her and avoid drama, you get to know everyone else. Have a happy senior year for the rest of the year. Attend clubs, parties and everyone forgets about the incident about the smell. You make an unforgettable friend group and graduate.", "ENDING: HAPPILY EVER AFTER"], image: nil, edges: [], ending: true)
    ...
    25 : Node (id: 25, paragraphs: ["You accept your fate and take the hit from him. He beats you up repeatedly and leaves you barely breathing. You end up having to go to the hospital and later you find out Derek and Claire got back together.", "ENDING BAD"], image: nil, edges: [], ending: true)
        
        ,
        
    28 : Node (id: 28, paragraphs: ["ENDING: DETENTION"], image: nil, edges: [], ending: true)
